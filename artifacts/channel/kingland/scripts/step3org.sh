...
echo
echo "========= Finish adding Org${ORG_NAME_NUMBER} to your first network ========= "
echo
CHANNEL_NAME="$1"
DELAY="$2"
LANGUAGE="$3"
...
do
    echo "===================== Installing chaincode ${CHAINCODE_VERSION} on peer0.org${i} ===================== "
    installChaincode 0 ${i} ${CHAINCODE_VERSION}
done

echo "===================== Upgrading chaincode on peer0.org1 ===================== "
upgradeChaincode 0 1 ${CHAINCODE_VERSION}

echo
echo "========= Finished adding Org${ORG_NAME_NUMBER} to your network! ========= "
echo

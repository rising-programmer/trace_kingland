...
function printHelp() {
  ...
  echo "e.g.:"
  echo
  echo "sh network_setup.sh createPeerTemplate -p peer0.org1.kingland.com -o org1 -M Org1Msp -c couchdb -P 5984 -l 7051 -e 7053 -f docker-composer-peer1.yaml"
  echo
}
IMAGETAG="1.1.0"
...
for ((i=1;i<10000;i++))
do
    if [ ! -d "crypto-config/peerOrganizations/org${i}.kingland.com" ]; then
        break
    fi
    cd crypto-config/peerOrganizations/org${i}.kingland.com/users/Admin@org${i}.kingland.com/msp/keystore
    PRIV_KEY=$(ls *_sk)
    cd ${CURRENT_DIR}
...
function startPeerForOrg1(){
    sh network_setup.sh createPeerTemplate -f docker-compose-peer1.yaml -o org1 -M Org1MSP -p peer0.org1.kingland.com -c couchdb1 -P 5984 -l 7051 -e 7053
    sh network_setup.sh up -f docker-compose-peer1.yaml

    sh network_setup.sh createCATemplate -f docker-compose-ca-org1.yaml -o org1.kingland.com -P 7054
    sh network_setup.sh up -f docker-compose-ca-org1.yaml
}

## 启动Org1 peer节点
function startPeer1ForOrg1(){
    sh network_setup.sh createPeerTemplate -f docker-compose-peer12.yaml -o org1 -M Org1MSP -p peer1.org1.kingland.com -c couchdb5 -P 9984 -l 11051 -e 11053
    sh network_setup.sh up -f docker-compose-peer12.yaml
}

## 启动Org2 peer节点
function startPeer1ForOrg2(){
    sh network_setup.sh createPeerTemplate -f docker-compose-peer22.yaml -o org2 -M Org2MSP -p peer1.org2.kingland.com -c couchdb6 -P 10984 -l 12051 -e 12053
    sh network_setup.sh up -f docker-compose-peer22.yaml
}

## 启动Org3 peer节点
function startPeer1ForOrg3(){
    sh network_setup.sh createPeerTemplate -f docker-compose-peer32.yaml -o org3 -M Org3MSP -p peer1.org3.kingland.com -c couchdb7 -P 11984 -l 13051 -e 13053
    sh network_setup.sh up -f docker-compose-peer32.yaml
}

## 启动peer2节点和ca2节点
function startPeerForOrg2(){
    sh network_setup.sh createPeerTemplate -f docker-compose-peer2.yaml -o org2 -M Org2MSP -p peer0.org2.kingland.com -c couchdb2 -P 6984 -l 8051 -e 8053
    sh network_setup.sh up -f docker-compose-peer2.yaml

    sh network_setup.sh createCATemplate -f docker-compose-ca-org2.yaml -o org2.kingland.com -P 8054
    sh network_setup.sh up -f docker-compose-ca-org2.yaml
}

## 启动peer3节点和ca3节点
function startPeerForOrg3(){
    sh network_setup.sh createPeerTemplate -f docker-compose-peer3.yaml -o org3 -M Org3MSP -p peer0.org3.kingland.com -c couchdb3 -P 7984 -l 9051 -e 9053
    sh network_setup.sh up -f docker-compose-peer3.yaml
    
    sh network_setup.sh createCATemplate -f docker-compose-ca-org3.yaml -o org3.kingland.com -P 9054
    sh network_setup.sh up -f docker-compose-ca-org3.yaml
}

## 启动peer4节点和ca4节点
function startPeerForOrg4(){
    sh network_setup.sh createPeerTemplate -f docker-compose-peer4.yaml -o org4 -M Org4MSP -p peer0.org4.kingland.com -c couchdb4 -P 8984 -l 10051 -e 10053
    sh network_setup.sh up -f docker-compose-peer4.yaml

    sh network_setup.sh createCATemplate -f docker-compose-ca-org4.yaml -o org4.kingland.com -P 10054
    sh network_setup.sh up -f docker-compose-ca-org4.yaml
}

## 启动peer5节点和ca5节点
function startPeerForOrg5(){
    sh network_setup.sh createPeerTemplate -f docker-compose-peer5.yaml -o org5 -M Org5MSP -p peer0.org5.kingland.com -c couchdb5 -P 9984 -l 11051 -e 11053
    sh network_setup.sh up -f docker-compose-peer5.yaml

    sh network_setup.sh createCATemplate -f docker-compose-ca-org5.yaml -o org5.kingland.com -P 11054
    sh network_setup.sh up -f docker-compose-ca-org5.yaml
}

## 启动peer6节点和ca6节点
function startPeerForOrg6(){
    sh network_setup.sh createPeerTemplate -f docker-compose-peer6.yaml -o org6 -M Org6MSP -p peer0.org6.kingland.com -c couchdb6 -P 10984 -l 12051 -e 12053
    sh network_setup.sh up -f docker-compose-peer6.yaml

    sh network_setup.sh createCATemplate -f docker-compose-ca-org6.yaml -o org6.kingland.com -P 12054
